...
GEMINI_API_KEY="AIzaSyCVNU63RiC6H40x6xFyfVCIc2HRIolez_4"
...
def execute_gemini(prompt):
    ...
    generate_content_config = types.GenerateContentConfig(
        ...
        response_schema=genai.types.Schema(
            ...
            required=["sentiment_type", "sentiment_score", "topic", "keywords", "target_audience"], #,"engagement_type","reason_for_engagement","engagement_score"
            properties={
